 ...
 * da comparação: negativo se "a < b", positivo se "a > b" e zero se forem iguais.
 */
gint comparar_likes(gconstpointer a, gconstpointer b);

/**
 * @brief Executa a Query 3 para filtrar músicas com base em idade e critérios adicionais.
 *
 ...
 *
 * @param minAge Idade mínima dos usuários.
 * @param maxAge Idade máxima dos usuários.
 ...
 * usando os dados geridos pela estrutura de gestão.
 *
 * @param lista Lista inicial de músicas a ser processada.
 * @param gestor Estrutura de gestão usada para armazenar e recuperar dados relevantes.
